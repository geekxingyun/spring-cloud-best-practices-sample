...
public class NetflixEurekaServiceRegisterCenter02ServerApplication {

    public static void main(String[] args) {
        SpringApplication.run(NetflixEurekaServiceRegisterCenter02ServerApplication.class, args);
    }
